...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/MyPage.qml"), &QmlCacheGeneratedCode::_0x5f__MyPage_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/main.qml"), &QmlCacheGeneratedCode::_0x5f__main_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/MyPage.qml"), &QmlCacheGeneratedCode::_0x5f__MyPage_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/UART/main.qml"), &QmlCacheGeneratedCode::_0x5f_UART_main_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmake_resources)() {
    ::unitRegistry();
    Q_INIT_RESOURCE(release_qmake_resources_qmlcache);
    return 1;
}
...
int QT_MANGLE_NAMESPACE(qCleanupResources_qmake_resources)() {
    Q_CLEANUP_RESOURCE(release_qmake_resources_qmlcache);
    return 1;
}
