...
#include <memory>
#include "../../serial_interface/myserial.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MySerial_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MySerial_t qt_meta_stringdata_MySerial = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_MySerial[] = {
...
Q_CONSTINIT const QMetaObject MySerial::staticMetaObject = { {
    ...
    qt_meta_stringdata_MySerial.offsetsAndSizes,
    qt_meta_data_MySerial,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MySerial_t,
        // Q_OBJECT / Q_GADGET
